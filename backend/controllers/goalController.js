...
const getGoals = asyncHandler(async (req, res) => {
  ...
  //goals ko json format
  //res.send->why not used and why this
})
...
//all validations are being done in setGoals
  ...
  //hit and try isliye do baar veryify 
...
const updateGoal = asyncHandler(async (req, res) => {
  ...
  //see this why this is requried
  //suppose a banda hai already logged in and wo update karna chaa raha goal kissi dure ka whana mujhe chcek karna padh raha
